...
{
    public class RestaurantPictureController : Controller
    {
        private readonly Lazy<IPictureService> pictureService;
        private readonly Lazy<ILoggerFacade<RestaurantPictureController>> logger;

        public RestaurantPictureController(Lazy<IPictureService> pictureService, Lazy<ILoggerFacade<RestaurantPictureController>> logger)
        {
